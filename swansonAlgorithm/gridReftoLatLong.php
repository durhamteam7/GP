<?php
/**
 * Converts the gridRef of sites to lat,long.
 *
 *@author team7
*/
...
/**
 * Normalize a grid reference
 * Converts any grid ref into standard 6 figure format.
 *
 * @param string Grid reference to be converted to lat long
 *
 * @return string Normalized grid ref
 */
...
/**
 * Call to nearby.org.uk API
 * Converts any grid ref into lat long.
 *
 * @param string $gridRef Grid reference to be converted
 *
 * @return float[] Array of coordinates [lat,long]
 */
